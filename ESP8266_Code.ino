...
const char* USERNAME      =  "HTTPStonks";// Change this to your Duino-Coin username
...
const char jsonDashTXT[] PROGMEM = R"=====(
{"minig":{"hashrate":@@HASHRATE@@,"difficulty":@@DIFF@@,"shares":@@SHARES@@,"node":"@@NODE@@"},"device":{"type":" @@DEVICE@@","id":"@@ID@@","memory":@@MEMORY@@,"miner":"@@VERSION@@","ip":"@@IP_ADDR@@"}}
)=====";
